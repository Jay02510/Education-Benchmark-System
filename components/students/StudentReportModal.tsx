    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Academic Performance Report" size="xl">
            <div className="bg-white p-8 border border-gray-200 shadow-sm mx-auto max-w-3xl rounded-[2rem]">
                ...
                <div className="mb-10">
                    <h3 className="text-[10px] font-black uppercase text-slate-400 tracking-[0.2em] mb-4">Academic Record</h3>
                    <div className="p-8 bg-slate-50 border border-slate-100 rounded-[2.5rem] min-h-[180px] flex flex-col justify-center text-center">
                        <p className="text-slate-400 font-bold italic">
                            Report narrative manually compiled from classroom observations and logged action protocols.
                        </p>
                    </div>
                </div>
